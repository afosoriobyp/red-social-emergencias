  ...
  const base: Array<ReportInput & { createdAt: Date }> = [
    {
      ...
      gravity: "critica",
      description:
        "Deslizamiento de tierra sobre la vía que conduce al centro de Roldanillo. Hay personas atrapadas en un vehículo y la vía está intransitable.",
      lat: 4.4162,
      lng: -76.1501,
      address: "Vía principal, sector centro",
      city: "Roldanillo",
      contactPhone: "573154993117",
    ...
    },
    {
      ...
      gravity: "critica",
      description:
        "El hospital San Juan de Dios requiere médicos, enfermeras y suministros. Hay heridos graves tras el sismo.",
      lat: 4.4091,
      lng: -76.1523,
      address: "Hospital San Juan de Dios",
      city: "Roldanillo",
      contactPhone: "573154993117",
